Report 52092198 "Flag 13th Month Allce"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Flag 13th Month Allce.rdlc';
    ...
    dataset
    {
        dataitem(Employee; "Payroll-Employee")
        {
            ...
            begin
                ...
                Employee.SetFilter("ED Filter", PayrollSetup."ExGratia ED Code");
                Employee.CalcFields("ED Amount");
                Remarks := '';
                if Employee."ED Amount" <> 0 then
                    CurrReport.Skip;
                if PayslipLines.Get(PayrollPeriod, Employee."No.", PayrollSetup."ExGratia ED Code") then begin
            ...
            begin
                ...
                PayrollSetup.Get;
                PayrollSetup.TestField("ExGratia ED Code");
            end;
        }
    }
