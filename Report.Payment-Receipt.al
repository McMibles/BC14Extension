Report 52092544 "Payment - Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Payment - Receipt.rdlc';

    dataset
    {
        dataitem("Cash Receipt Header";"Cash Receipt Header")
        {
            ...
            dataitem("Cash Receipt Line";"Cash Receipt Line")
            {
    ...
    var
        ...
        PostedRcptLn: Record "Cash Receipt Line";
